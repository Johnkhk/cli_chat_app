...
func (x *UploadPublicKeyRequest) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *UploadPublicKeyRequest) GetPublicKey() []byte {
	if x != nil {
		return x.PublicKey
	}
	return nil
...
func (x *UploadPublicKeyResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *UploadPublicKeyResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type GetPublicKeyRequest struct {
	...
	UserId int32 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // The unique ID of the user whose public key is being requested
}
...
func (x *GetPublicKeyRequest) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
type GetPublicKeyResponse struct {
	...
	PublicKey []byte `protobuf:"bytes,1,opt,name=public_key,json=publicKey,proto3" json:"public_key,omitempty"` // The user's public key in bytes
	Success   bool   `protobuf:"varint,2,opt,name=success,proto3" json:"success,omitempty"`                     // Indicates if the retrieval was successful
	Message   string `protobuf:"bytes,3,opt,name=message,proto3" json:"message,omitempty"`                      // A message indicating the result of the retrieval
}
...
var file_proto_auth_auth_proto_rawDesc = []byte{
	...
	0x16, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79,
	...
	0x65, 0x79, 0x22, 0x4d, 0x0a, 0x17, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x50, 0x75, 0x62, 0x6c,
	...
	0x65, 0x22, 0x2e, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65,
	...
	0x64, 0x22, 0x69, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65,
	...
	0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x63, 0x63,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xea, 0x02, 0x0a,
	0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3f, 0x0a, 0x0c,
	...
	,
...
var file_proto_auth_auth_proto_goTypes = []any{
	...
	(*UploadPublicKeyRequest)(nil),  // 6: auth.UploadPublicKeyRequest
	(*UploadPublicKeyResponse)(nil), // 7: auth.UploadPublicKeyResponse
	(*GetPublicKeyRequest)(nil),     // 8: auth.GetPublicKeyRequest
	(*GetPublicKeyResponse)(nil),    // 9: auth.GetPublicKeyResponse
}
var file_proto_auth_auth_proto_depIdxs = []int32{
	...
	6, // 3: auth.AuthService.UploadPublicKey:input_type -> auth.UploadPublicKeyRequest
	8, // 4: auth.AuthService.GetPublicKey:input_type -> auth.GetPublicKeyRequest
	...
	7, // 8: auth.AuthService.UploadPublicKey:output_type -> auth.UploadPublicKeyResponse
	9, // 9: auth.AuthService.GetPublicKey:output_type -> auth.GetPublicKeyResponse
...
func file_proto_auth_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_auth_auth_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*UploadPublicKeyRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_auth_auth_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*UploadPublicKeyResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
