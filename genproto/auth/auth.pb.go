...
type LoginResponse struct {
	...
	Success      bool   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	Message      string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	AccessToken  string `protobuf:"bytes,3,opt,name=access_token,json=accessToken,proto3" json:"access_token,omitempty"`    // Add access_token to the response
	RefreshToken string `protobuf:"bytes,4,opt,name=refresh_token,json=refreshToken,proto3" json:"refresh_token,omitempty"` // Add refresh_token to the response
}
...
type RefreshTokenRequest struct {
	...
	RefreshToken string `protobuf:"bytes,1,opt,name=refresh_token,json=refreshToken,proto3" json:"refresh_token,omitempty"` // The refresh token provided by the client
}
...
type RefreshTokenResponse struct {
	...
	AccessToken string `protobuf:"bytes,1,opt,name=access_token,json=accessToken,proto3" json:"access_token,omitempty"` // The new access token issued by the server
}
...
type UploadPublicKeyRequest struct {
	...
	Username  string `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"`                    // Username of the user uploading the public key
	PublicKey []byte `protobuf:"bytes,2,opt,name=public_key,json=publicKey,proto3" json:"public_key,omitempty"` // The user's public key in bytes
}
...
type UploadPublicKeyResponse struct {
	...
	Message string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`  // A message indicating the result of the upload
}
...
var file_proto_auth_auth_proto_rawDesc = []byte{
	...
	0x65, 0x32, 0xa1, 0x02, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x65, 0x22, 0x00, 0x12, 0x50, 0x0a, 0x0f, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x50, 0x75, 0x62,
	0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x12, 0x1c, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x55, 0x70,
	0x6c, 0x6f, 0x61, 0x64, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x55, 0x70, 0x6c, 0x6f,
	0x61, 0x64, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f,
...
var file_proto_auth_auth_proto_depIdxs = []int32{
	...
	1, // 4: auth.AuthService.RegisterUser:output_type -> auth.RegisterResponse
	3, // 5: auth.AuthService.LoginUser:output_type -> auth.LoginResponse
	5, // 6: auth.AuthService.RefreshToken:output_type -> auth.RefreshTokenResponse
	7, // 7: auth.AuthService.UploadPublicKey:output_type -> auth.UploadPublicKeyResponse
