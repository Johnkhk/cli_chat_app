...
var file_proto_auth_auth_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x32, 0xa0, 0x02, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x4f, 0x0a, 0x10, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x50, 0x75,
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x6a, 0x6f, 0x68, 0x6e, 0x6b, 0x68, 0x6b, 0x2f, 0x63, 0x6c, 0x69, 0x5f,
	0x63, 0x68, 0x61, 0x74, 0x5f, 0x61, 0x70, 0x70, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x61,
...
var file_proto_auth_auth_proto_depIdxs = []int32{
	...
	2, // 2: auth.AuthService.LoginUser:input_type -> auth.LoginRequest
	4, // 3: auth.AuthService.RefreshToken:input_type -> auth.RefreshTokenRequest
	6, // 4: auth.AuthService.UploadPublicKeys:input_type -> auth.PublicKeyUploadRequest
	1, // 5: auth.AuthService.RegisterUser:output_type -> auth.RegisterResponse
	...
	8, // 8: auth.AuthService.UploadPublicKeys:output_type -> auth.PublicKeyUploadResponse
