...
type MessageRequest struct {
	...
	RecipientId      int32  `protobuf:"varint,1,opt,name=recipient_id,json=recipientId,proto3" json:"recipient_id,omitempty"`               // Unique identifier of the recipient (user or group ID)
	...
	FileSize         int64  `protobuf:"varint,8,opt,name=file_size,json=fileSize,proto3" json:"file_size,omitempty"`                        // (Optional) Size of the file in bytes
}
...
func (x *MessageRequest) GetRecipientId() int32 {
	if x != nil {
...
func (x *MessageRequest) GetFileSize() int64 {
	if x != nil {
		return x.FileSize
	}
	return 0
...
type MessageResponse struct {
	...
	MessageId    string `protobuf:"bytes,1,opt,name=message_id,json=messageId,proto3" json:"message_id,omitempty"`          // The message ID of the message being acknowledged
	Status       string `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"`                                 // Status of the message (e.g., "delivered", "read", "error")
	Timestamp    string `protobuf:"bytes,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"`                           // Timestamp of when the server processed or acknowledged the message
	ErrorMessage string `protobuf:"bytes,4,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"` // (Optional) Error message if the message processing failed
}
...
var file_proto_chat_chat_proto_rawDesc = []byte{
	...
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x63, 0x68, 0x61, 0x74, 0x22, 0x97, 0x02,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x72, 0x65, 0x63, 0x69, 0x70, 0x69, 0x65, 0x6e,
	...
	0x69, 0x6c, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x22, 0x8b, 0x01, 0x0a, 0x0f, 0x4d, 0x65, 0x73, 0x73,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x50, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x41, 0x0a, 0x0e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x12, 0x14, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x4d, 0x65,
	...
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6a, 0x6f, 0x68, 0x6e, 0x6b, 0x68, 0x6b, 0x2f, 0x63, 0x6c,
	0x69, 0x5f, 0x63, 0x68, 0x61, 0x74, 0x5f, 0x61, 0x70, 0x70, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_proto_chat_chat_proto_depIdxs = []int32{
	0, // 0: chat.ChatService.StreamMessages:input_type -> chat.MessageRequest
	1, // 1: chat.ChatService.StreamMessages:output_type -> chat.MessageResponse
